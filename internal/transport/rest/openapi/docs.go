        ...
        "/api/v1/catalog/compute/instances": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Instance category (general_purpose, compute_optimized, etc.)",
                        "name": "category",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Instance family (t3, c5, Standard_D, etc.)",
                    ...
                    {
                        "type": "number",
                        "description": "Minimum RAM in GiB",
                        "name": "min_memory_gib",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "description": "Maximum RAM in GiB",
                        "name": "max_memory_gib",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.CatalogInstancesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.CatalogSummaryResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "rest.CatalogInstancesResponse": {
            ...
            "properties": {
                ...
                "instances": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ComputeCatalogItem"
                    }
                },
                "total": {
                    "type": "integer"
