...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_transport_rest.DatabaseComparisonResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_transport_rest.DatabaseNoSQLComparisonResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_transport_rest.KubernetesComparisonResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_transport_rest.ServerlessComparisonResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "github_com_thatengineerguy21_CloudVitta_internal_domain.ClusterTopology": {
            "type": "string",
            "enum": [
                "zonal",
                "regional",
            ...
            "x-enum-varnames": [
                "ClusterTopologyZonal",
                "ClusterTopologyRegional",
                "ClusterTopologyAutopilot"
            ]
        },
        ...
        "github_com_thatengineerguy21_CloudVitta_internal_domain.DatabaseNoSQLAttributes": {
            "type": "object",
            "properties": {
                "component_type": {
        ...
        "github_com_thatengineerguy21_CloudVitta_internal_domain.DatabaseRDBMSAttributes": {
            "type": "object",
            "properties": {
                "component_type": {
        ...
        "github_com_thatengineerguy21_CloudVitta_internal_domain.KubernetesAttributes": {
            "type": "object",
            "properties": {
                "cluster_topology": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_thatengineerguy21_CloudVitta_internal_domain.ClusterTopology"
                        }
                    ]
                },
                "tier": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_thatengineerguy21_CloudVitta_internal_domain.KubernetesTier"
                        }
                    ]
                }
            }
        },
        "github_com_thatengineerguy21_CloudVitta_internal_domain.KubernetesTier": {
            "type": "string",
            "enum": [
                "free",
                "standard",
            ...
            "x-enum-varnames": [
                "KubernetesTierFree",
                "KubernetesTierStandard",
                "KubernetesTierExtendedSupport"
            ]
        },
        ...
        "github_com_thatengineerguy21_CloudVitta_internal_domain.ServerlessRateAttributes": {
            "type": "object",
            "properties": {
                "architecture": {
                ...
                "component_type": {
                    "description": "\"request_fee\", \"duration_fee\"",
                    "type": "string"
                },
                "tier": {
        ...
        "internal_transport_rest.DatabaseComparisonMeta": {
            "type": "object",
            "properties": {
                "api_version": {
                    "type": "string"
        ...
        "internal_transport_rest.DatabaseComparisonResponse": {
            "type": "object",
            "properties": {
                "meta": {
                    "$ref": "#/definitions/internal_transport_rest.DatabaseComparisonMeta"
                },
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_transport_rest.DatabaseResultEntry"
                    }
                },
                "warnings": {
                    "type": "array",
        ...
        "internal_transport_rest.DatabaseNoSQLComparisonMeta": {
            "type": "object",
            "properties": {
                "api_version": {
                    "type": "string"
        ...
        "internal_transport_rest.DatabaseNoSQLComparisonResponse": {
            "type": "object",
            "properties": {
                "meta": {
                    "$ref": "#/definitions/internal_transport_rest.DatabaseNoSQLComparisonMeta"
                },
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_transport_rest.DatabaseNoSQLResultEntry"
                    }
                },
                "warnings": {
                    "type": "array",
        ...
        "internal_transport_rest.DatabaseNoSQLResultEntry": {
            "type": "object",
            "properties": {
                "fetched_at": {
                    "type": "string"
                ...
                "matched_spec": {
                    "$ref": "#/definitions/github_com_thatengineerguy21_CloudVitta_internal_domain.DatabaseNoSQLAttributes"
                },
                "missing_attributes": {
                    "type": "array",
                    "items": {
        ...
        "internal_transport_rest.DatabaseResultEntry": {
            "type": "object",
            "properties": {
                "fetched_at": {
                    "type": "string"
                ...
                "matched_spec": {
                    "$ref": "#/definitions/github_com_thatengineerguy21_CloudVitta_internal_domain.DatabaseRDBMSAttributes"
                },
                "missing_attributes": {
                    "type": "array",
                    "items": {
        ...
        "internal_transport_rest.KubernetesComparisonMeta": {
            "type": "object",
            "properties": {
                "api_version": {
                    "type": "string"
        ...
        "internal_transport_rest.KubernetesComparisonResponse": {
            "type": "object",
            "properties": {
                "meta": {
                    "$ref": "#/definitions/internal_transport_rest.KubernetesComparisonMeta"
                },
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_transport_rest.KubernetesResultEntry"
                    }
                },
                "warnings": {
                    "type": "array",
        ...
        "internal_transport_rest.KubernetesResultEntry": {
            "type": "object",
            "properties": {
                "fetched_at": {
                    "type": "string"
                ...
                "matched_spec": {
                    "$ref": "#/definitions/github_com_thatengineerguy21_CloudVitta_internal_domain.KubernetesAttributes"
                },
                "missing_attributes": {
                    "type": "array",
                    "items": {
        ...
        "internal_transport_rest.ServerlessComparisonMeta": {
            "type": "object",
            "properties": {
                "api_version": {
                    "type": "string"
        ...
        "internal_transport_rest.ServerlessComparisonResponse": {
            "type": "object",
            "properties": {
                "meta": {
                    "$ref": "#/definitions/internal_transport_rest.ServerlessComparisonMeta"
                },
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_transport_rest.ServerlessResultEntry"
                    }
                },
                "warnings": {
                    "type": "array",
        ...
        "internal_transport_rest.ServerlessResultEntry": {
            "type": "object",
            "properties": {
                "fetched_at": {
                    "type": "string"
                ...
                "matched_spec": {
                    "$ref": "#/definitions/github_com_thatengineerguy21_CloudVitta_internal_domain.ServerlessRateAttributes"
                },
                "missing_attributes": {
                    "type": "array",
                    "items": {
